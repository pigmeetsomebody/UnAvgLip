...
class LoRAAttnProcessor(nn.Module):
    ...
    def __init__(
        ...
        # print(f"init LoRAAttnProcessor, lora_scale: {self.lora_scale}")
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # print(f"attention scale: {self.lora_scale}")
...
class LoRAIPAttnProcessor(nn.Module):
    ...
    def __init__(self, hidden_size, cross_attention_dim=None, rank=4, network_alpha=None, lora_scale=0.5, scale=0.5, num_tokens=4):
        super().__init__()
        self.rank = rank
        self.lora_scale = lora_scale
        # print(f"init LoRAIPAttnProcessor, scale:{scale}, lora_scale: {lora_scale}")
        self.to_q_lora = LoRALinearLayer(hidden_size, hidden_size, rank, network_alpha)
        self.to_k_lora = LoRALinearLayer(cross_attention_dim or hidden_size, hidden_size, rank, network_alpha)
        self.to_v_lora = LoRALinearLayer(cross_attention_dim or hidden_size, hidden_size, rank, network_alpha)
        self.to_out_lora = LoRALinearLayer(hidden_size, hidden_size, rank, network_alpha)
