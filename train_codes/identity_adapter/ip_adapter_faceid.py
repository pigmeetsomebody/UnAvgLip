...
class LinerPProjModel(torch.nn.Module):
    def __init__(self, cross_attention_dim=768, id_embeddings_dim=512, num_tokens=4):
        super().__init__()
        ...
        self.proj = torch.nn.Linear(id_embeddings_dim, cross_attention_dim*num_tokens)
        self.norm = torch.nn.LayerNorm(cross_attention_dim)
...
class IPAdapterFaceID:
    ...
    def load_ip_adapter(self):
        ...
        ip_layers.load_state_dict(state_dict["identity_adapter"])
